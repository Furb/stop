        ...
        <div className='container'>
          <div className='footerContent one__two-col'>
            ...
            <div className='footerBeskrivelse'>
              <p>
                Sammen kan vi bygge en fremtid,hvor svindlere afskrækkes,
                svindel afsløres, ogdanskere er rustet med viden og værktøjer
                til atbeskytte sig selv.
              </p>
            </div>
          </div>
          <hr />
